...
def preprocessing(df):
    ## →ここではリスト化するだけ、前処理はdata_collatorで行う
...
# BLEUを利用するための関数を用意
metric = evaluate.load("bleu")  ## bleu→0~1
